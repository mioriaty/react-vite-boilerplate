export const moneyFormats = {
  ...
  BCH: {
    money_format: '{{amount}} BCH',
    money_with_currency_format: '{{amount}} BCH',
  ...
  BGN: {
    ...
    money_name: 'Bulgarian Leva',
  },
  ETH: {
    money_format: '{{amount}} ETH',
    money_with_currency_format: '{{amount}} ETH',
    money_name: 'Ethereum',
  },
  MMK: {
  ...
  HUF: {
    ...
    money_with_currency_format: '{{amount}} Ft HUF',
  ...
  MYR: {
    money_format: 'Rs {{amount}}RM{{amount}} MYR',
...
export const currencyData: Array<{ label: string; value: string }> = Object.entries(moneyFormats).reduce((acc, [key, value]) => {
  acc.push({ label: `${key} - ${value.money_name}`, value: key });
  return acc;
}, [] as any);
...
export const getSymbolAmount = (currencies: typeof moneyFormats, currentCurrency: string, currentAmount: number | string) => {
  ...
  // @ts-ignore
  const currencyObject = currencies[currentCurrency];
  const formattedAmount = currencyObject.money_format.replace('{{amount}}', currentAmount);
